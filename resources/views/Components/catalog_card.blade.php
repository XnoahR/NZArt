<div class="max-w-sm rounded overflow-hidden shadow-lg border pt-3 flex flex-col dark:text-white text-black">
    <div>
    ...
    <div class="flex justify-end me-3 mb-4 ">
        <a href="#" class="bg-blue-500 hover:bg-blue-700 text-white  py-2 px-4 rounded-full">
            Detail
        </a>
    </div>
</div>
