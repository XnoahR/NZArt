...
@section('content')
    <section class="w-full h-80s flex items-center border border-red-500">
        ...
        <form class="max-w-sm px-2.5 mx-auto ">
            <div class="mb-5 ">
                <label for="username"
                    class="block mb-2 ms-2 text-sm font-medium text-gray-900 dark:text-white">Username</label>
            ...
            <div class="mb-5">
                <label for="no-hp" class="block mb-2 ms-2 text-sm font-medium text-gray-900 dark:text-white">No
                    HP</label>
